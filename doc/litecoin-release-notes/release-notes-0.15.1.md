ChocolateChip Core version *0.15.1* is now available from:

  <https://download.chocolatechip.org/chocolatechip-0.15.1/>
...
A number of changes to the way ChocolateChip Core deals with peer connections and invalid blocks
