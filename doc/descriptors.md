# Support for Output Descriptors in ChocolateChip Core

Since ChocolateChip Core v0.17, there is support for Output Descriptors. This is a
...
on ChocolateChip's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing ChocolateChip Core wallets, a convenience function `combo` is
