...
"""Verify that starting chocolatechip with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start chocolatechip with -h for help text")
        ...
        self.log.info("Start chocolatechip with -version for version information")
        ...
        self.log.info("Start chocolatechipd with -fakearg to make sure it does not start")
