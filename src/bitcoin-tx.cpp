...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " chocolatechip-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  chocolatechip-tx [options] <hex-tx> [commands]  Update hex-encoded chocolatechip transaction\n" +
            "or:     chocolatechip-tx [options] -create [commands]   Create hex-encoded chocolatechip transaction\n" +
            "\n";
