...
#if defined(NDEBUG)
# error "ChocolateChip cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "ChocolateChip Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("chocolatechip-scriptch");
